...
/**
 * Class for the inventory of the player. The player inventory can contain items and can be printed. The player inventory can also remove
 * and add items. The player inventory also has a weight limit.
 */
public class PlayerInventory extends CreatureInventory
{
     ...
     */
    @Override public boolean addObject(Item item) {
